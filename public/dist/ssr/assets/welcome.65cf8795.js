...
var InertiaLogo = /* @__PURE__ */ pluginVue_exportHelper._export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender]]);
const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(vue.mergeProps({ class: "p-6" }, _attrs))}><div class="flex items-center"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-500"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg><div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">${serverRenderer.ssrInterpolate(__props.name)}</a></div></div><div class="ml-12"><div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">`);
      serverRenderer.ssrRenderSlot(_ctx.$slots, "default", {}, () => {
        _push(`${serverRenderer.ssrInterpolate(__props.description)}`);
      }, _push, _parent);
      _push(`</div></div></div>`);
    };
  }
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(vue.mergeProps({ class: "relative flex items-top justify-center min-h-screen bg-zinc-100 dark:bg-zinc-900 sm:items-center py-4 sm:pt-0" }, _attrs))}><div class="max-w-6xl mx-auto sm:px-6 lg:px-8"><div class="flex justify-center items-center pt-8 space-x-12 sm:pt-0">`);
      _push(serverRenderer.ssrRenderComponent(LaravelLogo, { class: "h-20 w-auto text-[#EF3B2D]" }, null, _parent));
      _push(serverRenderer.ssrRenderComponent(InertiaLogo, { class: "h-11 w-auto text-[#826ded]" }, null, _parent));
      ...
      _push(serverRenderer.ssrRenderComponent(_sfc_main$1, {
        name: "Documentation",
      ...
      _push(serverRenderer.ssrRenderComponent(_sfc_main$1, {
        ...
        default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              vue.createTextVNode(" Laravel's robust library of first-party tools and libraries, such as "),
              vue.createVNode("a", {
              ...
              vue.createTextVNode(" help you take your projects to the next level. Pair them with powerful open source libraries like "),
              vue.createVNode("a", {
