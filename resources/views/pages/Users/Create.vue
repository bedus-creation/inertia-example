                  ...
                  <div class="divide-y divide-gray-200">
                        ...
                        <div class="mt-6 sm:ml-6 sm:flex-1">
                          ...
                          >
                            <button
                              ...
                              "
                            >
                              <Link as="button" method="post" href="/users" :data="{}" preserve-scroll preserve-state>Message</Link>
                            </button>
                            <button
                              type="button"
                              class="
                    ...
                    <div class="px-4 py-5 sm:px-0 sm:py-0">
                      <dl
                        class="
                          space-y-8
                          sm:space-y-0 sm:divide-y sm:divide-gray-200
                        "
                      >
